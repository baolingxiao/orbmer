...
const DICT = {
  zh: {
    ...
    "home.featured": "精品推荐",
    "home.featured.body": "编辑精选与值得入手的安静好物。",
    ...
    "label.craft": "工艺",
    "discover.title": "发现",
    "discover.body": "不要搜索。去探索。每一个系列都是通往工艺、材料与设计的路径。",
    "discover.new": "新发现",
  ...
  en: {
    ...
    "home.featured.body": "Quiet pieces our editors would take home.",
    ...
    "discover.body": "Do not search. Explore. Each collection is a path through craftsmanship, materials, and design.",
